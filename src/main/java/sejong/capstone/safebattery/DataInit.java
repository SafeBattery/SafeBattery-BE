...
public class DataInit {
    ...
    public void dataInit() {
        ...
        for (int i = 0; i < 600; i++) {
            Record record = new Record(pemfc, i, 0.956, 0.112, 0.107, 7.749, 1.052, 94.016, 100.098, 0.96, 0.556, 1.059, 0.677, 14.691, -64762.981, 34.011, 14.584, 29.724, 18.663, 42.509, 64.992, 0.024, 0.002, 0, 0);
